...
public class TestNIO_2 {
    @Test
    public void test1(){
        Path path = Paths.get("d:","ni/12.avi");
        //必须整个文件名,2.avi也是false
        System.out.println(path.endsWith("12.avi"));
    ...
    public void test2(){
        ...
        Path path2 = Paths.get("TestBuffer.java");
    ...
    public void test3() throws IOException {
        Path path1 = Paths.get("D:/1.avi");
        Path path2 = Paths.get("d:/4.avi");
    ...
    public void test5() throws IOException{
        Path path1 = Paths.get("d:/1.avi");
        Path path2 = Paths.get("d:/nio/1.avi");
    ...
    public void test7() throws IOException{
        SeekableByteChannel newByteChannel = Files.newByteChannel(Paths.get("d:/1.avi"), StandardOpenOption.READ);
    ...
    public void test8() throws IOException{
        ...
        FileChannel outChannel = FileChannel.open(Paths.get("D:/5.avi"), StandardOpenOption.WRITE, StandardOpenOption.CREATE);
